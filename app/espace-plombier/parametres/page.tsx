...
export default function PlombierParametresPage() {
  const t = useTranslations('plumber.parametres');
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3 p-4 bg-white rounded-xl border border-gray-100">
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                ...
                {getCities(plombier?.country ?? 'MA').map((c) => (
          ...
          >
            ...
            <span className="font-medium text-gray-900">{t('documentsValidation')}</span>
          ...
          >
            ...
            <span className="font-medium text-gray-900">{tCommon('logout')}</span>
          </button>
        </div>
      </main>
    </div>
